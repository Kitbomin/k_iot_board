...
public class BoardFile {
    ...
    @JoinColumn(name = "board_id", nullable = false, foreignKey = @ForeignKey(name = "fk_board_files_board"))
    private Board board;

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "file_id", nullable = false, foreignKey = @ForeignKey(name = "fk_board_files_file_info"))
